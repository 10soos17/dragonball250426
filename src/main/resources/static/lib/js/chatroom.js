...
$( document ).ready(function() {
	...
	function openSocket() {
		...
		var serverUrl = "ws://localhost:8081/ws/chat";//10.10.36.54
	...
	//====================메시지 전송 후, 화면에 그리기 
 	var addMessage = function(data) {
		...
		if(type == "FILE"){
	        ...
	        var localPath = "/Users/soos/Desktop/ChatroomDemo2/src/main/resources"
	        console.log("localPath+filePath:",localPath+filePath);
			messages.append(sendMessage);
			var img = 
			`<div>
	      		<img src="${path}" alt="test" width="42" height="42"> 
	        </div>`
